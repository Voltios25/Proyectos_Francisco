        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              <h1 class="box-title">Terramozas <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar</button><a target="_blank" href="../reportes/rptTerramoza.php"> <button class="btn btn-info"> Reporte</button></a></h1>
            ...
            <form name="formulario" id="formulario" method="POST">
                          <div class="inputWithIcon form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label>DNI:</label>
                              <input type="hidden"class="form-control" name="id_terramoza" id="id_terramoza">
                            <input type="text"  class="form-control" name="dni_terramoza" id="dni_terramoza" placeholder="DNI" required="">
                          </div>
                          <div class="inputWithIcon form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label>Nombre:</label>
                            <input type="text" class="form-control" name="nombrest" id="nombrest" placeholder="Nombre" required="">
                          </div>
                          <div class="inputWithIcon form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
...
?>
<script type="text/javascript" src="../js/terramoza.js"></script>
